...
public class GenericService : IGenericService
{
    ...
    public async Task<string> TestPost<TRequest>(TRequest content)
    {
        var url = ServiceEndpoints.TestPost; // Replace with the actual URL

        // Call the generic PostAsync method with your request object
        var response = await _genericHttpClient.PostAsync<TRequest, string>(url, content);
    ...
    public async Task<String> TestDelete()
    {
        ...
        var result = await _genericHttpClient.GetAsync<object>(testApiUrl);
